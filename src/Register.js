...
.then(
  ...
  return(
    ...
    <div class="input-field inputstl padt15 col s12 t-aleft mart30">
      <input placeholder=". . . . ."  required  class="validate u-feild"  pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" type="password"autoComplete="off" onChange={(e)=>setPassword(e.target.value)}/>
    ...
    <div class="input-field inputstl padt15 col s12 t-aleft mart30">
      <input placeholder=". . . . ."  required  class="validate u-feild" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" type="password"autoComplete="off" onChange={(e)=>setRpassword(e.target.value)}/>
      <i class="material-icons prefix validate right s-color">lock</i>
